...
class FindExtraIngredientsByProductUseCaseImpl(
    ...
    override operator fun invoke(input: FindExtraIngredientsByProductInput): List<sb.pma.core.domain.extraProductIngredient.output.ExtraProductIngredientsOutput> {
